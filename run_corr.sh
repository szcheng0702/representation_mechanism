...
if [ "$1" = "train" ]; then
    mkdir -p results/step/dim/hidden300_corr_0.05noise
    mkdir -p results/ramp/dim/hidden300_corr_0.05noise
    python3 TrainRNNfromconfig.py --config_file ./corrstep.ini --baseDirectory ./results/step/dim/hidden300_corr_0.05noise/ --baseSaveFileName fixedHiddenTrainingResults --gpu_idx 3
    python3 TrainRNNfromconfig.py --config_file ./corrramp.ini --baseDirectory ./results/ramp/dim/hidden300_corr_0.05noise/ --baseSaveFileName fixedHiddenTrainingResults --gpu_idx 3
