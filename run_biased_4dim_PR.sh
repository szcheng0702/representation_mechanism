...
if [ "$1" = "train" ]; then
    ...
    python3 TrainRNNfromconfig.py --config_file ./biased_corrnewramp.ini --baseDirectory ./results/ramp_PRRandom/dim/hidden400epo3000dim4_biasedcorr_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults --gpu_idx 4
    ...
    python3 TrainRNNfromconfig.py --config_file ./biased_corrnewramp.ini --time 2 --epochNum 200  --baseDirectory ./testing/newramp/dim/hidden400epo3000dim4_biasedcorr_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults
    ...
    python3 TrainRNNfromconfig.py --mode 'test' --config_file ./biased_corrnewramp.ini --time 2 --epochNum 200 --baseDirectory ./testing/newramp/dim/hidden400epo3000dim4_biasedcorr_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults
elif [ "$1" = "test" ]; then
    ...
    python3 TrainRNNfromconfig.py --mode 'test' --config_file ./biased_corrnewramp.ini --baseDirectory ./results/ramp_PRRandom/dim/hidden400epo3000dim4_biasedcorr_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults
fi