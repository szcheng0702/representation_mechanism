...
if [ "$1" = "train" ]; then
    ...
    mkdir -p results/sine/dim/hidden1000epo4000
    ...
    python3 TrainRNNfromconfig.py --config_file ./config/sineconfig.ini --baseDirectory ./results/sine/dim/hidden1000epo4000/ --baseSaveFileName fixedHiddenTrainingResults --gpu_idx 5
elif [ "$1" = "train_local" ]; then
    # mkdir -p testing/step/hidden400epo3000_corr_newramp_0.1noise
    mkdir -p testing/sine/dim/hidden1000epo4000
    ...
    python3 TrainRNNfromconfig.py --config_file ./config/sineconfig.ini --epochNum 100  --baseDirectory ./testing/sine/dim/hidden1000epo4000/ --baseSaveFileName fixedHiddenTrainingResults
    ...
    python3 TrainRNNfromconfig.py --mode 'test' --config_file ./config/sineconfig.ini --epochNum 100 --baseDirectory ./testing/sine/dim/hidden1000epo4000/ --baseSaveFileName fixedHiddenTrainingResults
elif [ "$1" = "test" ]; then
    ...
    python3 TrainRNNfromconfig.py --mode 'test' --config_file ./config/sineconfig.ini --baseDirectory ./results/sine/dim/hidden1000epo4000/ --baseSaveFileName fixedHiddenTrainingResults
fi