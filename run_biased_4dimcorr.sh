...
if [ "$1" = "train" ]; then
    ...
    cp ./config/biased_corrramp_PRRandom.ini results/ramp_PRRandom/dim/hidden500epo5000dim4_biasedcorr_0.1noise
    ...
    python3 TrainRNNfromconfig.py --config_file ./config/biased_corrramp_PRRandom.ini --baseDirectory ./results/ramp_PRRandom/dim/hidden500epo5000dim4_biasedcorr_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults --gpu_idx 0
    ...
    python3 TrainRNNfromconfig.py --config_file ./config/biased_corrramp_PRRandom.ini --time 2 --epochNum 200  --baseDirectory ./testing/ramp_PRRandom/dim/hidden500epo5000dim4_biasedcorr_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults
    ...
    python3 TrainRNNfromconfig.py --mode 'test' --config_file ./config/biased_corrramp_PRRandom.ini --time 2 --epochNum 200 --baseDirectory ./testing/ramp_PRRandom/dim/hidden500epo5000dim4_biasedcorr_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults
elif [ "$1" = "test" ]; then
    ...
    python3 TrainRNNfromconfig.py --mode 'test' --config_file ./config/biased_corrramp_PRRandom.ini --baseDirectory ./results/ramp_PRRandom/dim/hidden500epo5000dim4_biasedcorr_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults
fi