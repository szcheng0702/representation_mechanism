...
if [ "$1" = "train" ]; then
    ...
    python3 TrainRNNfromconfig.py --mode 'test' --config_file ./biased_corrnewramp.ini --baseDirectory ./results/newramp/dim/hidden400epo3000dim4_biasedcorr_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults
fi