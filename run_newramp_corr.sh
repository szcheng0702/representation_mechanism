...
if [ "$1" = "train" ]; then
    ...
    mkdir -p results/newramp/dim/hidden400epo3000_corr_newramp_0.1noise
    ...
    python3 TrainRNNfromconfig.py --config_file ./corrnewramp.ini --baseDirectory ./results/newramp/dim/hidden400epo3000_corr_newramp_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults --gpu_idx 3
elif [ "$1" = "train_local" ]; then
    # mkdir -p testing/step/dim/hidden400epo3000_corr_newramp_0.1noise
    mkdir -p testing/newramp/dim/hidden400epo3000_corr_newramp_0.1noise
    ...
    python3 TrainRNNfromconfig.py --config_file ./corrnewramp.ini --time 2 --epochNum 200  --baseDirectory ./testing/newramp/dim/hidden400epo3000_corr_newramp_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults
    ...
    python3 TrainRNNfromconfig.py --mode 'test' --config_file ./corrnewramp.ini --baseDirectory ./results/newramp/dim/hidden400epo3000_corr_newramp_0.1noise/ --baseSaveFileName fixedHiddenTrainingResults
fi