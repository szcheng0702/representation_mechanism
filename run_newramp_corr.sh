...
if [ "$1" = "train" ]; then
    ...
    python3 TrainRNNfromconfig.py --config_file ./config/corrnewramp.ini --epochNum 200  --baseDirectory ./testing/newramp/perfecttest/ --baseSaveFileName fixedHiddenTrainingResults
