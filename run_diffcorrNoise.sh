...
if [ "$1" = "train" ]; then
    ...
    python3 run.py --config_file ./config/corrnewramp.ini --baseDirectory ./results/newramp/corrNoise/hidden500/ --baseSaveFileName fixedHiddenTrainingResults --gpu_idx 3
    ...
    python3 run.py --config_file ./config/corrnewramp.ini --time 2 --epochNum 50  --baseDirectory ./testing/newramp/corrNoise/hidden500/ --baseSaveFileName fixedHiddenTrainingResults
fi